...
\author{Zoubida Asmaa Boudjenane \affilnum{1} and Mohammed SALEM \affilnum{2}}

\affiliation{\affilnum{1}Computer Science Department, University of Mascara, Algeria\\
\affilnum{2}LISYS Laboratory, University of Mascara, Algeria}

\corrauth{Mohammed SALEM, LISYS Lab, University of Mascara, BP 305 Route Mamounia, Mascara, 29000, Algeria.}
...
\begin{table}[h]
	...
	\begin{tabular}{|c|p{5cm}|}  % Use p{width} for text wrapping
		\hline
